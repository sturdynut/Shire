...
/// Posts tender-agent's alerts as real macOS notifications from Tender. The agent writes every alert to alerts.jsonl;
...
final class AppNotifications: NSObject, UNUserNotificationCenterDelegate {
    ...
    func deliverNew(from paths: TenderPaths) {

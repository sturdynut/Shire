...
public struct ShireConfig: Equatable, Sendable {
    ...
    /// Services that Shire generates LaunchAgents for.
...
public struct RemoteSettings: Equatable, Sendable, Decodable {
    ...
    public var port: Int
    /// Where shire-agent listens on this Mac, behind tailscale serve. Only 127.0.0.1.

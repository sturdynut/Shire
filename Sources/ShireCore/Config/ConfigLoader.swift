...
public enum ConfigLoader {
    public static func load(from url: URL) throws -> ShireConfig {
    ...
    public static func parse(_ text: String) throws -> ShireConfig {
        let node: Node?
        do {
        ...
        guard let node else { return ShireConfig() }
        try checkKeys(node)

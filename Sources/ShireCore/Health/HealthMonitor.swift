...
/// A service's health as shire-agent has seen it over time, not just the last check.
...
public final class HealthMonitor {
    ...
    @discardableResult
    public func runDueChecks(config: ShireConfig, now: Date = Date()) -> [String: ServiceHealth] {
...
extension HealthProbe {
    /// For shire-agent's synchronous loop.

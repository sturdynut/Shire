...
extension ShireSnapshot.Service.Tone {
    var color: Color {
        switch self {
...
struct MenuContent: View {
    ...
    private var footer: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            MenuButton(title: "Quit Shire menu", shortcut: "⌘Q") { NSApp.terminate(nil) }
            Text("Quitting the menu leaves your services and shire-agent running.")
...
struct MenuServiceRow: View {
    var service: ShireSnapshot.Service
    var busy: Bool
    var open: () -> Void
    var restart: () -> Void
